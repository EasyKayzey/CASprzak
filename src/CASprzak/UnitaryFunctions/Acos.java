...
public class Acos extends UnitaryFunction {
    ...
    public Function getDerivative(int varID) {
        return new Multiply(new Multiply(function.getDerivative(varID), new Constant(-1)), new Reciprocal(new Pow(new Constant(0.5), ( new Add(new Constant(1), new Multiply(new Constant(-1), new Pow(new Constant(2), function)))))));
    }

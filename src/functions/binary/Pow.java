...
public class Pow extends BinaryFunction {
	...
	public Function getDerivative(char varID) {
		if (function1 instanceof Constant exponent)
			...
			return new Product(new Pow(function1, function2), new Sum(new Product(function1.getSimplifiedDerivative(varID), new Ln(function2)), new Product(new Product(function1, function2.getSimplifiedDerivative(varID)), new Pow(Constant.NEGATIVE_ONE, function2))));
	}

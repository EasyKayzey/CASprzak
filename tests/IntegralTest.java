...
public class IntegralTest {
    ...
    void splitAdds() {
        ...
        GeneralFunction test2 = new Sum(Parser.parse("0.5*x^2"), Parser.parse("e^x"));
    ...
    void unwrapsExponents() {
        ...
        GeneralFunction test2 = new Sum(Parser.parse("(x^5)/5"), Parser.parse("4/3*x^3"), Parser.parse("4x"));
        assertEquals(test2, test1.execute());
    }

    @Test
    void stripConstantsSimple() {
        GeneralFunction test1 = Parser.parse("3\\sin(x)");
    ...
    void simpleExponentIntegral() {
        ...
        GeneralFunction test2 = Parser.parse("e^x");
        assertEquals(test2, test1.execute());
    }
    ...
    void simpleExponentIntegralWithConstant() {
        ...
        GeneralFunction test2 = Parser.parse("2e^x");
        assertEquals(test2, test1.execute());
    }
    ...
    void simpleExponentIntegralWithLinerTermInExponent() {
        ...
        GeneralFunction test2 = Parser.parse("e^(2x-3)");
        assertEquals(test2, test1.execute());
    }
    ...
    void simplePowers() {
        ...
        GeneralFunction test2 = Parser.parse("1/3 * x^3");
        assertEquals(test2, test1.execute());
    }
    ...
    void simpleTrigWithConstants() {
        ...
        GeneralFunction test2 = Parser.parse("2*\\sin(2x+3)");
        assertEquals(test2, test1.execute());
    }
    ...
    void simpleReciprocal() {
        ...
        GeneralFunction test2 = Parser.parse("\\ln(1+e^x)");
        assertEquals(test2, test1.execute());
    }
    ...
    void simpleSquareRoot() {
        ...
        GeneralFunction test2 = Parser.parse("1/3 * (1+x^2)^(3/2)");
        assertEquals(test2, test1.execute());
    }
    ...
    void simpleExpUSub() {
        ...
        GeneralFunction test2 = Parser.parse("1/2*e^(x^2)");
        assertEquals(test2, test1.execute());
    }
    ...
    @Test
    void simpleOPIsOne() {
        GeneralFunction test1 = new Integral(Parser.parse("\\cos(x)*\\sin(x)"), 'x').execute();
        GeneralFunction test2 = Parser.parse("1/2*(\\sin(x))^2");
        GeneralFunction test3 = Parser.parse("-1/2*(\\cos(x))^2");
    ...
    void complexUSub() {
        ...
        GeneralFunction test2 = Parser.parse("-1/3*(\\cos(e^x))^3");
        assertEquals(test2, test1.execute());
    }
    ...
    void severalVariableBasic() {
        ...
        GeneralFunction test2 = Parser.parse("1/(y+1)*x^(y+1)");
        assertEquals(test2, test1.execute());
    }
    ...
    void severalVariableBasicFunctionOfXAndY1() {
        ...
        GeneralFunction test2 = Parser.parse("1/3*e^(3x+y)");
        assertEquals(test2, test1.execute());
    }
    ...
    void severalVariableBasicFunctionOfXAndY2() {
        ...
        GeneralFunction test2 = Parser.parse("1/(3y)*e^(3xy+y)");
        assertEquals(test2, test1.execute());
    }
}
